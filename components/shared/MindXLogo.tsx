	...
	return (
		<div className={`flex items-center ${s.gap} select-none`}>
			...
			>
				X
				<span
					className={`absolute -top-1 -left-1.5 ${s.dot} rounded-full bg-[#e53e3e]`}
				/>
				<span
					className={`absolute -top-1 -right-1.5 ${s.dot} rounded-full bg-[#dd6b20]`}
				/>
				<span
					className={`absolute -bottom-1 -left-1.5 ${s.dot} rounded-full bg-[#3182ce]`}
				/>
				<span
					className={`absolute -bottom-1 -right-1.5 ${s.dot} rounded-full bg-[#38a169]`}
				/>
			</span>
			<span
