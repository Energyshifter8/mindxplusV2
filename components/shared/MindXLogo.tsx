...
const sizes = {
	sm: { scale: 0.625, width: 100, height: 28 },
	md: { scale: 0.8125, width: 130, height: 36 },
	lg: { scale: 1, width: 160, height: 44 },
} as const;

const MindXLogo = memo(function MindXLogo({
	className = "",
	size = "md",
}: MindXLogoProps) {
	const s = sizes[size];
